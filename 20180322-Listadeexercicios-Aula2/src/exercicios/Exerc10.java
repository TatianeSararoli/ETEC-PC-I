...
public class Exerc10 {
	...
	public static void main(String[] args) {
		...
		//Exercício 10: Faça um programa que leia as variáveis C e N, respectivamente
		//				código e número de horas trabalhadas de um operário. Calcule
		...
		//				O programa só deve parar de rodar quando o usuário responder
		//				"S"	na seguinte pergunta, "Deseja encerrar o programa?".
